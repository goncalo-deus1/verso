...
export type ConcelhoAML = {
  ...
  profile: ZoneProfile
  oneLine: string
  /** Optional EN translation of oneLine. Falls back to PT when missing. */
  oneLineEn?: string
...
export const concelhosAML: ConcelhoAML[] = [
  // ─── Lisboa ──────────────────────────────────────────────────────────────────
  {
    ...
    oneLineEn: 'The capital — where everything is closer, and everything costs more.',
  ...
  // ─── Margem Norte ─────────────────────────────────────────────────────────────
  {
    ...
    oneLineEn: 'Between Lisboa and Cascais, with rail, parks and corporate infrastructure.',
  ...
  },
  {
    ...
    oneLineEn: 'A town by the Atlantic with a direct train to Lisboa.',
  ...
  },
  {
    ...
    oneLineEn: 'The town of Romanticism, with the serra at the doorstep and Lisboa 40 minutes away by train.',
  ...
  },
  {
    ...
    oneLineEn: 'Dense, multicultural, with a direct metro to Lisboa in 20 minutes.',
  ...
  },
  {
    ...
    oneLineEn: 'Lisboa 15 minutes away by metro, with prices that still hold out.',
  ...
  },
  {
    ...
    oneLineEn: 'Green, space and the Tejo close by — the most rural part of the north bank.',
  ...
  },
  {
    ...
    oneLineEn: 'Ericeira, the Palace and 40 km of coastline an hour from Lisboa.',
  ...
  },
  {
    ...
    oneLineEn: 'A wide Tejo, frequent trains and prices that reflect the distance.',
    ...
    image: '/concelhos/vila-franca-de-xira.webp',
    populationApprox: 145_000,
    populationTrend3y: 'stable',
    crimeLevel: 'médio',
  ...
  // ─── Margem Sul ───────────────────────────────────────────────────────────────
  {
    ...
    oneLineEn: 'Cristo Rei, the ferry and a proper city — the south bank that is being discovered.',
  ...
  },
  {
    ...
    oneLineEn: 'A south-bank municipality close to Lisboa, with river beaches and prices still in check.',
  ...
  },
  {
    ...
    oneLineEn: 'Riverfront, industrial heritage being redeveloped, and the most affordable prices 25 minutes from Lisboa.',
  ...
  },
  {
    ...
    oneLineEn: 'The Tejo estuary, space, and the lowest T2 rents in AML.',
  ...
  },
  {
    ...
    oneLineEn: 'Gateway to the Alentejo with ferry, bridge and the prospect of the new airport.',
  ...
  },
  {
    ...
    oneLineEn: 'Salt marsh, sea salt and silence — the quiet side of the Vasco da Gama bridge.',
    ...
    budgetFitT2: { min: 650, max: 950 },
    image: '/concelhos/alcochete.webp',
  ...
  },
  {
    ...
    oneLineEn: 'One of the most beautiful beaches in AML, on a fishing-village scale.',
  ...
  },
  {
    ...
    oneLineEn: 'A port city with the Arrábida at the doorstep and the Atlantic close by.',
  ...
  },
  {
    ...
    oneLineEn: 'Setúbal wine, a medieval castle and rural quiet.',
