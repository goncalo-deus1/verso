...
**Resumo rápido:** Sintra é o segundo maior concelho da AML em população, com cerca de 386 mil residentes. A renda mediana de um T2 ronda os 850 a 950 euros, mais barata do que Lisboa, Cascais ou Oeiras. Boa escolha para famílias que procuram casa maior por menos dinheiro e tolerem deslocações de comboio. Menos indicada para quem precisa de chegar ao centro de Lisboa em menos de 40 minutos em hora de ponta.
...
<script type="application/ld+json">
{
  ...
  "@graph": [
    {
      "@type": "Place",
      "name": "Concelho de Sintra",
      "description": "Segundo maior concelho da Área Metropolitana de Lisboa, com 385.954 residentes. Renda mediana de T2 entre 850 e 950 euros mensais.",
      "address": {
        "@type": "PostalAddress",
    ...
    },
    {
      ...
      "mainEntity": [
        {
          "@type": "Question",
          "name": "Quanto custa arrendar um T2 em Sintra em 2026?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "A renda mediana de um T2 em Sintra fica entre 850 e 950 euros nas zonas da linha de comboio. A renda por metro quadrado é de 10,82 euros, segundo o INE (4T 2024)."
          }
        },
        {
          "@type": "Question",
          "name": "Vale a pena viver em Sintra trabalhando em Lisboa?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Sim, se usar a linha de comboio Lisboa-Sintra. O tempo da estação de Sintra ao Rossio é cerca de 40 minutos."
          }
        },
        {
          "@type": "Question",
          "name": "Quais são as zonas mais baratas de Sintra?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Algueirão-Mem Martins fora dos núcleos centrais e Almargem do Bispo têm rendas T2 abaixo dos 800 euros."
          }
        }
      ]
    }
